...
- **[Accounts](accounts.md)** covers the optional front end login, registration, the sent-secret history, keeping account holders out of wp-admin, and the tradeoff that emailing a link makes.
